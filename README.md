# 💫 Привет!
На данный момент я изучаю чистый JavaScript и уже начинаю <br>изучение библиотеки React.js. В свободное время я занимаюсь <br>веб-дизайном и собственным pet-проектом. Активно ищу работу на позицию HTML-верстальщика 
