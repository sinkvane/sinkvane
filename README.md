# 💫 Привет!:
На данный момент я изучаю чистый JavaScript и уже начинаю <br>изучение библиотеки React.js. В свободное время я занимаюсь <br>веб-дизайном.


## 🌐 Socials:
[![Behance](https://img.shields.io/badge/Behance-1769ff?logo=behance&logoColor=white)](https://behance.net/Sinkvane Designer) [![Discord](https://img.shields.io/badge/Discord-%237289DA.svg?logo=discord&logoColor=white)](https://discord.gg/JeltokFront#5185) 
...
## 🏆 GitHub Trophies
![](https://github-profile-trophy.vercel.app/?username=sinkvane&theme=tokyonight&no-frame=false&no-bg=false&margin-w=4)

### 🔝 Top Contributed Repo
![](https://github-contributor-stats.vercel.app/api?username=sinkvane&limit=5&theme=tokyonight&combine_all_yearly_contributions=true)
